...
/**
 * Alex - AI Architect
 * Specialized in system architecture, technical design, and solution architecture
 */
...
import { ALEX_TEMPLATES } from './services/templates/templates.js';
...
export class Alex {
  ...
  private async setupTools() {
    ...
    ALEX_TEMPLATES.forEach(template => {
    ...
    this.toolRegistry.register(new ProcessMessageFor("Alex", "AI Architect"));
  ...
  private setupHandlers() {
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      if (name === "process-message-for-alex" && args && args.message) {
  ...
  async run() {
    ...
    console.error("Alex running on stdio");
  }
}
