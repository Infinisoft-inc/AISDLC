 ...
 * Comprehensive test suite for Next.js API route
 */
...
// Mock handlers
jest.mock('../handlers/installation-created', () => ({
  handleInstallationCreated: jest.fn()
}));

jest.mock('../handlers/installation-deleted', () => ({
...
describe('GitHub Webhook Route', () => {
  ...
  describe('POST /api/github/webhooks', () => {
    ...
    it('should log webhook processing', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith('📨 GitHub webhook received: installation (delivery-123)');
      expect(console.log).toHaveBeenCalledWith('✅ Successfully processed installation webhook');
    });
